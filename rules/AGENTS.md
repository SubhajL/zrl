...
- Current market subdirectories: `eu/`, `japan/`, `korea/`.
- Current rule files include: `rules/AGENTS.md`, `rules/eu/mango-substances.csv`, `rules/eu/mango.yaml`, `rules/japan/durian-substances.csv`, `rules/japan/durian.yaml`, `rules/japan/mango-substances.csv`, `rules/japan/mango.yaml`, `rules/japan/mangosteen-substances.csv`.
