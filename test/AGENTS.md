...
- E2E entry point(s) currently on disk: `test/analytics.e2e-spec.ts`, `test/app.e2e-spec.ts`, `test/audit-chain-integrity.e2e-spec.ts`, `test/audit.e2e-spec.ts`, `test/auth.e2e-spec.ts`, `test/cold-chain-live.e2e-spec.ts`, `test/cold-chain.e2e-spec.ts`, `test/dispute.e2e-spec.ts`, `test/evidence.e2e-spec.ts`, `test/integrations.e2e-spec.ts`, `test/jest-e2e.json`, `test/lane.e2e-spec.ts`, `test/mrv-lite.e2e-spec.ts`, `test/notifications.e2e-spec.ts`, `test/notifications.realtime.e2e-spec.ts`, `test/privacy.e2e-spec.ts`, `test/proof-pack-worker.e2e-spec.ts`, `test/proof-pack.e2e-spec.ts`, `test/rules-engine.e2e-spec.ts`, `test/test_sync_agents.py`.
- E2E Jest config: [`test/jest-e2e.json`](/Users/subhajlimanond/dev/zrl/test/jest-e2e.json).
- Root Jest config currently covers 43 unit test file(s) under `src/` via `*.spec.ts`.
