...
- E2E entry point(s) currently on disk: `test/app.e2e-spec.ts`, `test/audit.e2e-spec.ts`, `test/auth.e2e-spec.ts`, `test/jest-e2e.json`, `test/lane.e2e-spec.ts`, `test/rules-engine.e2e-spec.ts`, `test/test_sync_agents.py`.
- E2E Jest config: [`test/jest-e2e.json`](/Users/subhajlimanond/dev/zrl/test/jest-e2e.json).
- Root Jest config currently covers 9 unit test file(s) under `src/` via `*.spec.ts`.
