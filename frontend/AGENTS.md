...
- Current app files: `src/app/(app)/admin/rules/page.test.tsx`, `src/app/(app)/admin/rules/page.tsx`, `src/app/(app)/analytics/page.test.tsx`, `src/app/(app)/analytics/page.tsx`, `src/app/(app)/app-providers.tsx`, `src/app/(app)/checkpoint/capture/page.test.tsx`, `src/app/(app)/checkpoint/capture/page.tsx`, `src/app/(app)/dashboard/page.test.tsx`, `src/app/(app)/dashboard/page.tsx`, `src/app/(app)/error.tsx`, `src/app/(app)/lanes/[laneId]/_components/lane-detail-tabs.tsx`, `src/app/(app)/lanes/[laneId]/_components/lane-header.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-audit-trail.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-checkpoints.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-dispute.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-evidence.test.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-evidence.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-proof-packs.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-temperature.test.tsx`, `src/app/(app)/lanes/[laneId]/_components/tab-temperature.tsx`, `src/app/(app)/lanes/[laneId]/page.test.tsx`, `src/app/(app)/lanes/[laneId]/page.tsx`, `src/app/(app)/lanes/new/page.test.tsx`, `src/app/(app)/lanes/new/page.tsx`, `src/app/(app)/lanes/page.test.tsx`, `src/app/(app)/lanes/page.tsx`, `src/app/(app)/layout.tsx`, `src/app/(app)/partner/page.test.tsx`, `src/app/(app)/partner/page.tsx`, `src/app/(app)/settings/page.test.tsx`, `src/app/(app)/settings/page.tsx`, `src/app/(auth)/error.tsx`, `src/app/(auth)/layout.tsx`, `src/app/(auth)/login/page.test.tsx`, `src/app/(auth)/login/page.tsx`, `src/app/api/partner/_shared.ts`, `src/app/api/partner/lab-results/route.ts`, `src/app/api/partner/temperature/route.ts`, `src/app/api/partner/validate/route.ts`, `src/app/api/session/login/route.ts`, `src/app/api/session/logout/route.ts`, `src/app/api/session/mfa/route.ts`, `src/app/api/session/ws-token/route.test.ts`, `src/app/api/session/ws-token/route.ts`, `src/app/api/zrl/[...path]/route.ts`, `src/app/favicon.ico`, `src/app/globals.css`, `src/app/layout.tsx`, `src/app/page.tsx`
- Additional frontend source directories currently on disk: `components/`, `hooks/`, `lib/`.
